                                ...
                                ?>
                                    ...
                                    <td><img style="width: 100px;" src="<?php echo base_url() . '/uploads/' . $adm->gambar ?>"></td> -->
                                        ...
                                        <td data-header="EMAIL">
                                            <div class="main"> <?php echo $adm->email; ?></div>
                                        </td>

                                        <td data-header="ALAMAT">
                                            <div class="main"> <?php echo $adm->alamat; ?></div>
                                        </td>

                                        <td data-header="NO WHATSAPP">
                                            <div class="main"> <?php echo $adm->no_wa; ?></div>
                                        </td>

                                        <td data-header="GAMBAR">
                                            <div class="main"> <img style="width: 100px;" src="<?php echo base_url() . '/uploads/' . $adm->gambar ?>"></div>
                                        </td>

                                        <td data-header="PASSWORD">
                                            <div class="main"> <?php echo $adm->password; ?></div>
                                        </td>


                                        <!-- tombol button -->
                                        <td data-header="AKSI">
                                            <?php echo anchor('operator/Dashboard_admin/detail_admin/' . $adm->id_adm, '<div class="btn btn-success btn-sm"><i class="fas fa-search-plus"></i></div>') ?>
                                            <?php echo anchor('operator/Dashboard_admin/edit_admin/' . $adm->id_adm, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?>
                                            <?php echo anchor('operator/Dashboard_admin/hapus_admin/' . $adm->id_adm, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?>
                                        </td>
                                    </tr>
