...
<div class="content-wrapper">
    ...
    <?php foreach ($donatur as $dnt) : ?>
        <form method="post" action="<?php echo base_url() . 'dkm/Dashboard_dkm/update_donator' ?>" enctype="multipart/form-data">
            ...
            <div class="for-group">
                ...
                <input type="text" name="id" class="form-control" value="<?php echo $dnt->id ?>" readonly>
            </div>
